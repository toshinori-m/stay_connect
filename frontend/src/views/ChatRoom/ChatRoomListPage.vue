    ...
    <div class="md:w-2/5 rounded-md shadow-gray-200 bg-sky-100">
      ...
      <div class="my-14">
        ...
        <div class="flex flex-col items-center justify-center">
          <div class="text-left my-3 sm:ml-4 sm:mr-6 w-72 pt-3 ring-offset-2 ring-2 rounded-lg" type="text" v-for="chat_room in chat_rooms" :key="chat_room.id">チャットルーム名:{{ chat_room.name }}
