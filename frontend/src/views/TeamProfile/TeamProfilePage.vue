<template>
  <div class="flex items-center justify-center mt-32 md:mt-20">
    <div class="md:w-2/5 rounded-md shadow-gray-200 bg-sky-100">
      <h2 class="text-center pt-10 font-bold text-3xl text-blue-600">チーム紹介</h2>
      <div class="my-5">
        <form class= "text-center" @submit.prevent="TeamProfile">
          <ul>
            ...
            <li class="md:grid grid-cols-3 gap-4">
              <label class="md:place-self-start  md:mt-3 ml-4" for="event_name">チーム名</label>
              <input class="md:place-self-center mx-10 py-1 px-1 my-2 w-72 border-2 border-gray-200 box-border" id="event_name" type="text" required placeholder="チーム名" v-model="event_name">
            </li>
            <li class="md:grid grid-cols-3 gap-4 sm:flex sm:items-center">
              <label class="md:place-self-start md:mt-3 ml-6 mr-8" for="area">活動地域</label>
              <textarea class="md:place-self-center mx-10 text-start py-1 px-1 my-2 w-72 h-40 border-2 border-gray-200 box-border" id="area" name="textarea" required placeholder="活動地域" v-model="area"></textarea>
            </li>
            ...
            <li class="md:grid grid-cols-3 gap-4">
              <label class="md:place-self-start md:mt-3 mx-4" for="target_age">年齢</label>
            ...
            <li class="md:grid grid-cols-3 gap-4 sm:flex sm:items-center">
              <label class="md:place-self-start  md:mt-3 mx-4" for="record">活度実績</label>
              <textarea class="md:place-self-center text-start py-1 px-1 my-2 w-72 h-40 border-2 border-gray-200 box-border" name="textarea" v-model="track_record" id="record" required placeholder="track record"></textarea>
            </li>
            <li class="md:grid grid-cols-3 gap-4 sm:flex sm:items-center">
          ...
          <button class="cancel_button mb-5 mx-2 md:mx-5" @click="TeamProfileCancel">戻る</button>
        </form>
      </div>
    </div>
  </div>
